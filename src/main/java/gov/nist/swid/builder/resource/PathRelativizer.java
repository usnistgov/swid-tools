...
public class PathRelativizer {
   ...
   * base and target, 2) using ".." to change the context from the base to the target directory, and
   * 3) use of the remaining portion of the target path to complete the path segments.
   * 
   * @param base
