...
public class PathRelativizer {
    ...
    /**
     * Creates a relative sequence of path segments by 1) removing common path segments between the
     * base and target, 2) using ".." to change the context from the base to the target directory,
     * and 3) use of the remaining portion of the target path to complete the path segments.
     * 
     * @param base
     ...
     * System.out.println(baseUri.relativize(targetUri)); List<String> pathSegments =
     ...
     * relativize(baseUri, targetUri); System.out.println("Relative(URI) segments: " +
     * pathSegments); System.out.println("Relative(URI) URI: " + toURI(pathSegments));
