...
import gov.nist.secauto.swid.builder.TagType;
import gov.nist.secauto.swid.builder.ValidationException;
import gov.nist.secauto.swid.builder.output.AbstractJsonOutputHandler;
...
import gov.nist.secauto.swid.builder.resource.firmware.DigestType;
...
import gov.nist.secauto.swid.builder.resource.firmware.StringFirmwareIdentifier;
