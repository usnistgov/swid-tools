...
import gov.nist.swid.builder.resource.firmware.FirmwarePayloadDigest;
...
public class CBORFirmwareOutputHandler extends CBORSupport {
    ...
    private void writeField(CBORGenerator generator, long fieldId, DeviceIdentifier deviceIdentifier)
            throws IOException {
        ...
        if (deviceIdentifier.getIeee8021ar() != null) {
            writeBinaryField(generator, FIRMWARE_TARGET_DEVICE_IDENTIFIER_IEEE802_1_AR,
                    deviceIdentifier.getIeee8021ar());
        }
    ...
    private void writeField(CBORGenerator generator, long fieldId, FirmwarePayloadPackage payload) throws IOException {
        ...
        if (payload.getCompressionGuidance() != null) {
            writeBinaryField(generator, FIRMWARE_PAYLOAD_PACKAGE_COMPRESSION_GUIDANCE,
                    payload.getCompressionGuidance());
        }
