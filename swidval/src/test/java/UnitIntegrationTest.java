...
import gov.nist.secauto.decima.xml.testing.PathRunner;
...
@PathRunner.Requirements(value = "classpath:requirements.xml",
    extensions = "classpath:schema/swid-requirements-ext.xsd")
