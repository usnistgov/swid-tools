...
public class IsStringSetEqual extends ExtensionFunctionDefinition {
    private static final StructuredQName FUNCTION_QNAME
            = new StructuredQName("java-swid", "java:gov.nist.decima.swid.schematron", "isStringSetEqual");

    private static final SequenceType[] FUNCTION_ARGUMENTS = new SequenceType[] { SequenceType.STRING_SEQUENCE,
            SequenceType.STRING_SEQUENCE, SequenceType.OPTIONAL_STRING };
